...
import "daosys/protocols/dexes/uniswap/v2/libs/Math.sol";
import "daosys/protocols/dexes/uniswap/v2/libs/UQ112x112.sol";
import "daosys/protocols/dexes/uniswap/v2/interfaces/IUniswapV2ERC20.sol";
...
import "daosys/protocols/dexes/uniswap/v2/interfaces/IUniswapV2Callee.sol";

import "daosys/protocols/dexes/uniswap/v2/libs/SafeMath.sol";
...
contract UniV2PairStub is ERC20Target, IUniswapV2Pair {
    ...
    function _mintFee(uint112 _reserve0, uint112 _reserve1) private returns (bool feeOn) {
        ...
        if (feeOn) {
            if (kLast_ != 0) {
                uint rootK = Math._sqrt(uint(_reserve0) * (_reserve1));
                uint rootKLast = Math._sqrt(kLast_);
                if (rootK > rootKLast) {
