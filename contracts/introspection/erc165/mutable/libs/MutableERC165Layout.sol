...
library MutableERC165Layout {
     ...
     */
    function slot(
        MutableERC165Struct storage table
    ...
    function layout(
        bytes32 slot_
    ) external pure returns(MutableERC165Struct storage layout_) {
    ...
    function _layout(
        bytes32 slot_
    ) internal pure returns(MutableERC165Struct storage layout_) {
